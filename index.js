async function moduleProject4() {
  ...
  // 👉 Tasks 1 - 5 go here
  document.querySelector('#weatherWidget').getElementsByClassName.display = 'none'
  document.querySelector('#citySelect').addEventListener('change', async evt => {
    ...
    try {
      ...
      document.querySelector('#apparentTemp dis:nth-child(2)')
      ...
      apparent.textContent = descriptions.find(d => d[0] === day.weather_desription)[1]
